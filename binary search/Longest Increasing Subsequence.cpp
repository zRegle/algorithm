 ...
 * 例如: 现有递增子序列: [2,3,5,6], [2,3,4], [2,3], 待插入元素7
 * 我们只需要插入到[2,3,5,6]之后即可, 因为即使我们插入到[2,3,4]和[2,3]
 * 后续能插入到[2,3,4,7], [2,3,7]的元素X, 也必定能插入到[2,3,5,6,7]中, 并且得到的序列长度更长
 * 因此我们只需要关心"允许插入的 最长 子序列之后添加元素"即可
 * 
